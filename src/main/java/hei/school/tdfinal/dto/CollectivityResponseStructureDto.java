...
public class CollectivityResponseStructureDto {
    private Member president;
    private Member vicePresident;
    private Member treasurer;
    private Member secretary;

    public CollectivityResponseStructureDto(Member president, Member vicePresident, Member treasurer, Member secretary) {
